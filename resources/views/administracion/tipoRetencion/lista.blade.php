...
@section('js_after')
    ...
    <script>
        $('#borrar').on('show.bs.modal', function (event) {
            $("#borrarForm").attr('action','{{ url('/administracion/tipoRetencion/eliminar') }}');
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Tipos de Retencion</li>
                    <li class="breadcrumb-item active" aria-current="page">Lista</li>
                </ol>
            </nav>
        </div>              
            <div class="block-options">
                <button type="button" class="btn-block-option mr-2"><a href="{{ URL::to('administracion/tipoRetencion/nuevo') }}"><i class="fa fa-plus mr-1"></i> Nuevo</a></button>
        ...
        <form action="{{ url('/administracion/tipoRetencion/lista') }}" method="get">
            <div class="row">
            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                @foreach($tab_tipo_retencion as $key => $value)
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell">
                            ...
                            <a href="{{ url('/administracion/tipoRetencion/deshabilitar').'/'. $value->id }}">
                                <i class="fa fa-eye text-done mr-1"></i>
                            </a>
                            @else
                            <a href="{{ url('/administracion/tipoRetencion/habilitar').'/'. $value->id }}">
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                               @if ($value->in_activo == true)                                
                                <a href="{{ url('/administracion/tipoRetencion/editar').'/'. $value->id }}">
            ...
            {{ $tab_tipo_retencion->appends(Request::only(['perPage','q']))->render() }}         
