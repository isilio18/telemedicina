                            ...
                            <div class="block block-themed block-rounded block-bordered">
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select {!! $errors->has('tipo_contrato') ? 'is-invalid' : '' !!}" name="tipo_contrato" id="tipo_contrato" {{ $errors->has('tipo_contrato') ? 'aria-describedby="tipo_contrato-error" aria-invalid="true"' : '' }}>
                                            ...
                                            @foreach($tab_tipo_contrato as $tipo_contrato)
                                                <option value="{{ $tipo_contrato->id }}" {{ $tipo_contrato->id == old('tipo_contrato') ? 'selected' : '' }}>{{ $tipo_contrato->de_tipo_contrato }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {!! $errors->has('orden_preimpresa') ? 'is-invalid' : '' !!}" id="orden_preimpresa" name="orden_preimpresa" placeholder="Orden Pre-Impresa..." value="{{ old('orden_preimpresa') }}" {{ $errors->has('orden_preimpresa') ? 'aria-describedby="orden_preimpresa-error" aria-invalid="true"' : '' }}>
                                    ...
                                    <div class="form-group form-row">
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="js-flatpickr form-control {!! $errors->has('fecha_inicio') ? 'is-invalid' : '' !!}" id="fecha_inicio" name="fecha_inicio" placeholder="d-m-Y" data-date-format="d-m-Y" value="{{ old('fecha_inicio') }}" {{ $errors->has('fecha_inicio') ? 'aria-describedby="fecha_inicio-error" aria-invalid="true"' : '' }}>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="js-flatpickr form-control {!! $errors->has('fecha_fin') ? 'is-invalid' : '' !!}" id="fecha_fin" name="fecha_fin" placeholder="d-m-Y" data-date-format="d-m-Y" value="{{ old('fecha_fin') }}" {{ $errors->has('fecha_fin') ? 'aria-describedby="fecha_fin-error" aria-invalid="true"' : '' }}>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="js-flatpickr form-control {!! $errors->has('fecha_entrega') ? 'is-invalid' : '' !!}" id="fecha_entrega" name="fecha_entrega" placeholder="d-m-Y" data-date-format="d-m-Y" value="{{ old('fecha_entrega') }}" {{ $errors->has('fecha_entrega') ? 'aria-describedby="fecha_entrega-error" aria-invalid="true"' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox custom-control-primary mb-1">
                                            <input type="checkbox" class="custom-control-input" id="in_compromiso" name="in_compromiso" @if ( old('in_compromiso')) checked @endif >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {!! $errors->has('monto_contrato') ? 'is-invalid' : '' !!}" id="monto_contrato" name="monto_contrato" placeholder="Monto Contrato..." value="{{ old('monto_contrato') }}" {{ $errors->has('monto_contrato') ? 'aria-describedby="monto_contrato-error" aria-invalid="true"' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {!! $errors->has('garantia') ? 'is-invalid' : '' !!}" id="garantia" name="garantia" placeholder="Garantia..." value="{{ old('garantia') }}" {{ $errors->has('garantia') ? 'aria-describedby="garantia-error" aria-invalid="true"' : '' }}>
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group form-row">
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="js-flatpickr form-control {!! $errors->has('fecha_compra') ? 'is-invalid' : '' !!}" id="fecha_compra" name="fecha_compra" placeholder="d-m-Y" data-date-format="d-m-Y" value="{{ old('fecha_compra') }}" {{ $errors->has('fecha_compra') ? 'aria-describedby="fecha_compra-error" aria-invalid="true"' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select {!! $errors->has('iva') ? 'is-invalid' : '' !!}" name="iva" id="iva" {{ $errors->has('iva') ? 'aria-describedby="iva-error" aria-invalid="true"' : '' }}>
                                            ...
                                            @foreach($tab_iva_factura as $iva_factura)
                                                <option value="{{ $iva_factura->id }}" {{ $iva_factura->id == old('iva') ? 'selected' : '' }}>{{ $iva_factura->nu_iva_factura }}</option>
                                            @endforeach
                                        </select>
                                        @if( $errors->has('iva') )
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select {!! $errors->has('ejecutor_entrega') ? 'is-invalid' : '' !!}" name="ejecutor_entrega" id="ejecutor_entrega" {{ $errors->has('ejecutor_entrega') ? 'aria-describedby="ejecutor_entrega-error" aria-invalid="true"' : '' }}>
                                            ...
                                            @foreach($tab_ejecutor as $ejecutor_entrega)
                                                <option value="{{ $ejecutor_entrega->id }}" {{ $ejecutor_entrega->id == old('ejecutor_entrega') ? 'selected' : '' }}>{{ $ejecutor_entrega->nu_ejecutor }} - {{ $ejecutor_entrega->de_ejecutor }}</option>
                                            @endforeach
                                        </select>
                ...
                <div class="row justify-content-center push">
                    <div class="col-md-12">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id_tab_producto" id="id_tab_producto" value="{{ old('id_tab_producto') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-4">
                                <div class="custom-control custom-checkbox custom-control-primary mb-1">
                                    <input type="checkbox" class="custom-control-input" id="excento_iva" name="excento_iva" @if ( old('excento_iva')) checked @endif >
