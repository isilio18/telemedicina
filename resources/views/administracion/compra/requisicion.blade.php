                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        {{--<div class="form-group">
                            ...
                            <input type="text" class="js-flatpickr form-control {!! $errors->has('fecha') ? 'is-invalid' : '' !!}" id="fecha" name="fecha" placeholder="d-m-Y" data-date-format="d-m-Y" value="{{ old('fecha') }}" {{ $errors->has('fecha') ? 'aria-describedby="fecha-error" aria-invalid="true"' : '' }}>
                            @if( $errors->has('fecha') )
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('concepto') ? 'is-invalid' : '' !!}" id="concepto" name="concepto" placeholder="Concepto..." value="{{ empty(old('concepto'))? $data->de_concepto : old('concepto') }}" {{ $errors->has('concepto') ? 'aria-describedby="concepto-error" aria-invalid="true"' : '' }}>
