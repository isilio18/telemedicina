...
@section('js_after')
    ...
    <script>
        $('#borrar').on('show.bs.modal', function (event) {
            $("#borrarForm").attr('action','{{ url('/administracion/tipoPresupuesto/eliminar') }}');
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button type="button" class="btn-block-option mr-2"><a href="{{ URL::to('administracion/tipoPresupuesto/nuevo') }}"><i class="fa fa-plus mr-1"></i> Nuevo</a></button>
        ...
        <form action="{{ url('/administracion/tipoPresupuesto/lista') }}" method="get">
            <div class="row">
            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                @foreach($tab_tipo_presupuesto as $key => $value)
                    <tr>
                      <!--  <td class="font-w600">{{ $value->id }}</td> -->
                        ...
                        <td class="d-none d-sm-table-cell">
                            ...
                            <a href="{{ url('/administracion/tipoPresupuesto/deshabilitar').'/'. $value->id }}">
                                <i class="fa fa-eye text-done mr-1"></i>
                            </a>
                            @else
                            <a href="{{ url('/administracion/tipoPresupuesto/habilitar').'/'. $value->id }}">
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{ url('/administracion/tipoPresupuesto/editar').'/'. $value->id }}">
            ...
            {{ $tab_tipo_presupuesto->appends(Request::only(['perPage','q']))->render() }}         
