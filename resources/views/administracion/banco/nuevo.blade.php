...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/banco/guardar') }}" method="POST">
                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('sigla') ? 'is-invalid' : '' !!}" id="sigla" name="sigla" placeholder="Sigla..." value="{{ old('sigla') }}" {{ $errors->has('sigla') ? 'aria-describedby="sigla-error" aria-invalid="true"' : '' }}>
                            @if( $errors->has('sigla') )
