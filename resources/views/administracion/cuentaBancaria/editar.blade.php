...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/cuentaBancaria/guardar').'/'.$data->id }}" method="POST">
                    ...
                    <div class="col-md-10">
                        ...
                        @endif
                            ...
                            <select class="custom-select {!! $errors->has('tipo_cuenta') ? 'is-invalid' : '' !!}" name="tipo_cuenta" id="tipo_cuenta" {{ $errors->has('tipo_cuenta') ? 'aria-describedby="tipo_cuenta-error" aria-invalid="true"' : '' }}>
                                ...
                                <option value="{{ $tipo_cuenta->id }}" {{ $tipo_cuenta->id == $data->id_tab_tipo_cuenta_bancaria ? 'selected' : '' }}>{{ $tipo_cuenta->de_tipo_cuenta_bancaria }}</option>
                                @endforeach
                            </select>
                            ...
                            <select class="custom-select {!! $errors->has('banco') ? 'is-invalid' : '' !!}" name="banco" id="banco" {{ $errors->has('banco') ? 'aria-describedby="banco-error" aria-invalid="true"' : '' }}>
                                ...
                                <option value="{{ $banco->id }}" {{ $banco->id == $data->id_tab_banco ? 'selected' : '' }}>{{ $banco->de_banco }}</option>
                                @endforeach
                            </select>
                            @if( $errors->has('banco') )
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('numero_cuenta_bancaria') ? 'is-invalid' : '' !!}" id="numero_cuenta_bancaria" name="numero_cuenta_bancaria" placeholder="Nuemro de cuenta..." value="{{ empty(old('numero_cuenta_bancaria'))? $data->nu_cuenta_bancaria : old('numero_cuenta_bancaria') }}" {{ $errors->has('numero_cuenta_bancaria') ? 'aria-describedby="numero_cuenta_bancaria-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('descripcion') ? 'is-invalid' : '' !!}" id="descripcion" name="descripcion" placeholder="Descripcion..." value="{{ empty(old('descripcion'))? $data->de_cuenta_bancaria : old('descripcion') }}" {{ $errors->has('descripcion') ? 'aria-describedby="descripcion-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('numero_contrato') ? 'is-invalid' : '' !!}" id="numero_contrato" name="numero_contrato" placeholder="Nuemro de contrato..." value="{{ empty(old('numero_contrato'))? $data->nu_contrato : old('numero_contrato') }}" {{ $errors->has('numero_contrato') ? 'aria-describedby="numero_contrato-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-checkbox custom-control-primary mb-1">
                                <input type="checkbox" class="custom-control-input" id="fondo_tercero" name="fondo_tercero"@if ($data->in_fondo_tercero == true) checked @endif >
