            ...
            <div class="block-content">
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <h2 class="content-heading pt-0">Orden de Pago</h2>
                            ...
                            <div class="block block-themed block-rounded block-bordered">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="js-maxlength form-control {!! $errors->has('tx_concepto') ? 'is-invalid' : '' !!}" id="tx_concepto" name="tx_concepto" rows="3"  maxlength="100" placeholder="Concepto.." data-always-show="true" {{ $errors->has('tx_concepto') ? 'aria-describedby="tx_concepto-error" aria-invalid="true"' : '' }}>{{ old('tx_concepto') }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select {!! $errors->has('tipo_orden_pago') ? 'is-invalid' : '' !!}" name="tipo_orden_pago" id="tipo_orden_pago" {{ $errors->has('tipo_orden_pago') ? 'aria-describedby="tipo_orden_pago-error" aria-invalid="true"' : '' }}>
                                            ...
                                            @foreach($tab_tipo_orden_pago as $tipo_orden_pago)
                                                <option value="{{ $tipo_orden_pago->id }}" >{{ $tipo_orden_pago->de_tipo_orden_pago }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {!! $errors->has('monto') ? 'is-invalid' : '' !!}" readonly id="monto" name="monto" placeholder="Monto..." value="{{ empty(old('monto'))? $mo_pago : old('monto') }}" {{ $errors->has('monto') ? 'aria-describedby="monto-error" aria-invalid="true"' : '' }}>
                                    </div>                                    
