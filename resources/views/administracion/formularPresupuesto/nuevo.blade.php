...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/formularPresupuesto/guardar') }}" method="POST">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select {!! $errors->has('tipo_presupuesto') ? 'is-invalid' : '' !!}" name="tipo_presupuesto" id="tipo_presupuesto" {{ $errors->has('tipo_presupuesto') ? 'aria-describedby="tipo_presupuesto-error" aria-invalid="true"' : '' }}>
                                ...
                                <option value="{{ $tipo_presupuesto->id }}" {{ $tipo_presupuesto->id == old('tipo_presupuesto') ? 'selected' : '' }}>{{ $tipo_presupuesto->de_tipo_presupuesto }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select {!! $errors->has('ejecutor') ? 'is-invalid' : '' !!}" name="ejecutor" id="ejecutor" {{ $errors->has('ejecutor') ? 'aria-describedby="ejecutor-error" aria-invalid="true"' : '' }}>
                                ...
                                <option value="{{ $ejecutor->id }}" {{ $ejecutor->id == old('ejecutor') ? 'selected' : '' }}>{{ $ejecutor->de_ejecutor }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select {!! $errors->has('sector_presupuesto') ? 'is-invalid' : '' !!}" name="sector_presupuesto" id="sector_presupuesto" {{ $errors->has('sector_presupuesto') ? 'aria-describedby="tipo_presupuesto-error" aria-invalid="true"' : '' }}>
                                ...
                                @foreach($tab_sector_presupuesto as $sector_presupuesto)
                                    <option value="{{ $sector_presupuesto->id }}" {{ $sector_presupuesto->id == old('sector_presupuesto') ? 'selected' : '' }}>{{ $sector_presupuesto->nu_sector_presupuesto }}-{{ $sector_presupuesto->de_sector_presupuesto }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('codigo') ? 'is-invalid' : '' !!}" id="codigo" name="codigo" placeholder="Codigo..." value="{{ old('codigo') }}" {{ $errors->has('codigo') ? 'aria-describedby="codigo-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control {!! $errors->has('monto') ? 'is-invalid' : '' !!}" id="monto" name="monto" placeholder="Monto..." value="{{ old('monto') }}" {{ $errors->has('monto') ? 'aria-describedby="monto-error" aria-invalid="true"' : '' }}>
                            @if( $errors->has('monto') )
