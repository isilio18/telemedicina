...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/formularPresupuesto/accionEspecifica/guardar') }}" method="POST">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <input type="hidden" name="id_tab_formular_presupuesto" value="{{ $id_tab_formular_presupuesto }}">
        <div class="block">
