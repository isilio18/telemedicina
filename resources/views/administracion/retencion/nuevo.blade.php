...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/retencion/guardar') }}" method="POST">
            ...
            <div class="block-content">
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <input type="hidden" id="id_tab_cuenta_contable_retencion_por_pagar" name="id_tab_cuenta_contable_retencion_por_pagar" value="{{ old('id_tab_cuenta_contable_retencion_por_pagar') }}">
                                  
                        <div class="form-group">
                            <label for="nu_cuenta_contable_retencion_por_pagar">Cuenta Contable Retencion</label>
                            <div class="input-group">                            
                            <input type="text" class="form-control {!! $errors->has('nu_cuenta_contable_retencion_por_pagar') ? 'is-invalid' : '' !!}" readonly id="nu_cuenta_contable_retencion_por_pagar" name="nu_cuenta_contable_retencion_por_pagar" placeholder="Cuenta contable por pagar..." value="{{ old('nu_cuenta_contable_retencion_por_pagar') }}" {{ $errors->has('nu_cuenta_contable_retencion_por_pagar') ? 'aria-describedby="nu_cuenta_contable_retencion_por_pagar-error" aria-invalid="true"' : '' }}>
                        ...
                        <input type="hidden" id="id_tab_cuenta_contable_deposito_tercero" name="id_tab_cuenta_contable_deposito_tercero" value="{{ old('id_tab_cuenta_contable_deposito_tercero') }}">
                                  
                        <div class="form-group">
                            <label for="nu_cuenta_contable_deposito_tercero">Cuenta Contable Deposito tercero</label>
                            <div class="input-group">                            
                            <input type="text" class="form-control {!! $errors->has('nu_cuenta_contable_deposito_tercero') ? 'is-invalid' : '' !!}" readonly id="nu_cuenta_contable_deposito_tercero" name="nu_cuenta_contable_deposito_tercero" placeholder="Cuenta contable deposito tercero..." value="{{ old('nu_cuenta_contable_deposito_tercero') }}" {{ $errors->has('nu_cuenta_contable_deposito_tercero') ? 'aria-describedby="nu_cuenta_contable_deposito_tercero-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('nu_concepto_nomina') ? 'is-invalid' : '' !!}" id="nu_concepto_nomina" name="nu_concepto_nomina" placeholder="..." value="{{ old('nu_concepto_nomina') }}" {{ $errors->has('nu_concepto_nomina') ? 'aria-describedby="nu_concepto_nomina-error" aria-invalid="true"' : '' }}>
