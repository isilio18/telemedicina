...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/retencion/concepto/guardar').'/'.$data->id }}" method="POST">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="form-group form-row">
                            ...
                            <select class="custom-select {!! $errors->has('ramos') ? 'is-invalid' : '' !!}" name="ramos" id="ramos" {{ $errors->has('ramos') ? 'aria-describedby="ramos-error" aria-invalid="true"' : '' }}>
                                ...
                                <option value="{{ $ramos->id }}" {{ $ramos->id == $data->id_tab_ramo ? 'selected' : '' }}>{{ $ramos->de_ramo }}</option>
                                @endforeach
                            </select>
                            @if( $errors->has('ramos') )
                         ...
                         <div class="form-group form-row">
                            ...
                            <input type="text" class="form-control {!! $errors->has('porcentaje_retencion') ? 'is-invalid' : '' !!}" id="porcentaje_retencion" name="porcentaje_retencion" placeholder="% Retencion..." value="{{ empty(old('porcentaje_retencion'))? $data->porcentaje_retencion : old('porcentaje_retencion') }}" {{ $errors->has('porcentaje_retencion') ? 'aria-describedby="porcentaje_retencion-error" aria-invalid="true"' : '' }}>
                         ...
                         <div class="form-group form-row">
                            ...
                            <input type="text" class="form-control {!! $errors->has('monto_minimo') ? 'is-invalid' : '' !!}" id="monto_minimo" name="monto_minimo" placeholder="Monto Minimo..." value="{{ empty(old('monto_minimo'))? $data->mo_minimo : old('monto_minimo') }}" {{ $errors->has('monto_minimo') ? 'aria-describedby="monto_minimo-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group form-row">
                            ...
                            <textarea class="js-maxlength form-control {!! $errors->has('concepto') ? 'is-invalid' : '' !!}" id="concepto" name="concepto" rows="3"  maxlength="100" placeholder="Concepto.." data-always-show="true" {{ $errors->has('concepto') ? 'aria-describedby="concepto-error" aria-invalid="true"' : '' }}>{{ empty(old('concepto'))? $data->de_concepto : old('concepto') }}</textarea>
                        ...
                        <div class="form-group form-row">
                            ...
                            <input type="text" class="form-control {!! $errors->has('numero_concepto') ? 'is-invalid' : '' !!}" id="numero_concepto" name="numero_concepto" placeholder="Nº Concepto..." value="{{ empty(old('numero_concepto'))? $data->nu_concepto : old('numero_concepto') }}" {{ $errors->has('numero_concepto') ? 'aria-describedby="numero_concepto-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group form-row">
                            ...
                            <input type="text" class="form-control {!! $errors->has('sustraendo') ? 'is-invalid' : '' !!}" id="sustraendo" name="sustraendo" placeholder="Sustraendo..." value="{{ empty(old('sustraendo'))? $data->mo_sustraendo : old('sustraendo') }}" {{ $errors->has('sustraendo') ? 'aria-describedby="sustraendo-error" aria-invalid="true"' : '' }}>
