...
<div class="content content-full content-boxed">
    ...
    <div class="block block-rounded block-bordered">
        ...
        <form action="{{ url('/administracion/tesoreria/pendiente') }}" method="get">
            <div class="row">
                ...
                @foreach($tab_solicitud as $key => $value)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Detalle" onclick="location.href='{{ url('/administracion/tesoreria/detallePendiente').'/'. $value->id }}'">
