...
<div class="content content-full content-boxed">
    ...
    <!-- New Post -->
    <form action="{{ URL::to('administracion/fuenteFinanciamiento/guardar').'/'.$data->id }}" method="POST">
                ...
                <div class="row justify-content-center push">
                    <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('descripcion') ? 'is-invalid' : '' !!}" id="descripcion" name="descripcion" placeholder="Descripcion..." value="{{ empty(old('descripcion'))? $data->de_fuente_financiamiento : old('descripcion') }}" {{ $errors->has('descripcion') ? 'aria-describedby="descripcion-error" aria-invalid="true"' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {!! $errors->has('tx_sigla') ? 'is-invalid' : '' !!}" id="tx_sigla" name="tx_sigla" placeholder="Sigla..." value="{{ empty(old('tx_sigla'))? $data->tx_sigla : old('tx_sigla') }}" {{ $errors->has('tx_sigla') ? 'aria-describedby="tx_sigla-error" aria-invalid="true"' : '' }}>
