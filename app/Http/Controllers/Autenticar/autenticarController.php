...
namespace gobela\Http\Controllers\Autenticar;
//*******agregar esta linea******//
use gobela\Models\Autenticar\tab_usuario;
use gobela\Models\Autenticar\tab_privilegio_menu;
use gobela\Models\Autenticar\tab_menu;
use Auth;
use View;
use Redirect;
use Session;
...
use gobela\Http\Requests\loginRequest;
