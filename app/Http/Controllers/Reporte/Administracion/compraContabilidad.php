...
namespace gobela\Http\Controllers\Reporte\Administracion;
//*******agregar esta linea******//
...
use gobela\Models\Configuracion\tab_empresa;
...
use gobela\Http\Controllers\Reporte\Vertical;
...
class compraContabilidad extends Controller
{
    ...
    */
    public function Factura_SopAntiguoV2( $ruta)
    {
        ...
        $pdf->SetSubject('gobela');
        $pdf->SetKeywords('gobela, PDF, REPORTE');
        $pdf->AddPage();
